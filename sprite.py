...
class Starship(pg.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pg.image.load("cat_starship_h.png")
    ...
    def switch_mode(self):
        self.image = pg.image.load("cat_starship_v.png")
        self.image = pg.transform.scale(self.image, (100, 100))
...
class Captain(pg.sprite.Sprite):
    def __init__(self):
        ...
        # я заменил картинку капитана на амогуса
        self.image = pg.image.load("red_amogus.png")
...
class Alien(pg.sprite.Sprite):
    def __init__(self):
        ...
        # я заменил картинку пришельца на амогуса
        self.image = pg.image.load("blue_amogus.png")
        self.image = pg.transform.scale(self.image, (400, 400))
